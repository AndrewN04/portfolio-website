...
export function ProjectsGrid() {
  ...
  const pages = useMemo(() => Math.ceil(projects.length / itemsPerPage), []);
  ...
  return (
    <section className="py-20 bg-[#101322]" id="projects">
          ...
          <AnimatePresence mode="wait" initial={false} custom={direction}>
            ...
            >
              {visibleProjects.map((project) => (
                <article
                  key={project.title}
                  className="group bg-[#1a1d2d] rounded-xl overflow-hidden border border-slate-800 hover:border-slate-600 transition-all hover:shadow-xl hover:shadow-[#1337ec]/5 flex flex-col h-full"
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="text-xl font-bold text-white group-hover:text-[#1337ec] transition-colors">
                        {project.title}
                      </h3>
                      ...
                      {project.tech.map((techKey) => {
                        ...
                        return (
                          <span
                            ...
                            title={tech.label}
                          >
                            <Icon className="h-4 w-4" style={{ color: tech.color }} aria-hidden />
